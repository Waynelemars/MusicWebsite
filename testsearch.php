...
echo '<p align="right"><img src="obama.jpg" height="100" width="100"></p>';
//logout
...
<center><span style="color: cyan">    ________________</span>
<font size="40"><span style="color: white">Search</span></font>
<span style="color: cyan">    ________________</span></center>
...
//radio
<span style="color: black">____________________________________________________________________
<?PHP if(!m_Id==null) echo listen($m_Id) ?></span>
...
// change part buy botton and play button may change>
  ...
  if ($m_Id == '20') { echo '<center> The lazy song'; echo '</br><center><img src="lazysong.jpg" height="300" width="300"></center>'; }
